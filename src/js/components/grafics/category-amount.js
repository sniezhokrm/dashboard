...
import data from "../../../assets/data/categoryAmount.json";

const categoryAmount = (selector, chart, metric = "absolute") => {

  chart = DivergingBarChart(data, {
  ...
  function DivergingBarChart(data, {
    ...
    return document.querySelector(selector).appendChild(svg.node());
  }
